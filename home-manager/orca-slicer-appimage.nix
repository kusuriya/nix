...
let
  orcaslicer-nightly = pkgs.appimageTools.wrapType2 rec {
    ...
    version = "2.1.0-beta";
    src = pkgs.fetchurl {
      url = "https://github.com/SoftFever/OrcaSlicer/releases/download/nightly-builds/OrcaSlicer_Linux_V${version}.AppImage";
  ...
  orcaslicer-desktop = pkgs.writeTextDir "share/applications/OrcaSlicer.desktop" "	[Desktop Entry]\n	Version=2.0.0-beta\n	Type=Application\n	Name=OrcaSlicer\n	Exec=orcaslicer\n";

  orcaslicer-desktop-nightly = pkgs.writeTextDir "share/applications/OrcaSlicer-nightly.desktop" "	[Desktop Entry]\n	Version=2.0.0-beta\n	Type=Application\n	Name=OrcaSlicer-Nightly\n	Exec=orcaslicer-nightly\n";
